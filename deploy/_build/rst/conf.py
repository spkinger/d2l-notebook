...
project = "Deploying Demo for d2lbook"
copyright = ""
...
html_theme_options = {
    ...
    'header_links': [
        ('PDF', 'https://https://d2l-ai.github.io/d2l-book-deploy-demo/deply-demo.pdf', True, 'fas fa-file-pdf'),
    ],
    'show_footer': False
}
...
latex_documents = [
    (master_doc, "my-d2l-notebook.tex", "Deploying Demo for d2lbook",
     author, 'manual'),
]
